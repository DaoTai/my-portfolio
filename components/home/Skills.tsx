    ...
    <div id="skills" className="scroll-mt-20">
      ...
      <div className="grid grid-cols-1 items-start gap-4 gap-y-10 md:grid-cols-2 ">
        ...
        <div className="static space-y-4 md:sticky md:top-16">
          <p className="rounded-3xl border border-sky-400 bg-black/5 p-2 px-4 text-left text-2xl leading-10 backdrop-blur-2xl sm:text-justify sm:text-3xl">
          ...
          <p className="rounded-3xl border border-violet-400 bg-black/5 p-2 px-4 text-left text-2xl leading-10 backdrop-blur-2xl sm:text-justify sm:text-3xl">
          ...
          {techStack.map(({ imageUri, name }, i) => (
            ...
            >
              ...
              <div className="rounded-full border bg-gradient  px-4 py-1 backdrop-blur-3xl">
                <b className="text-sm font-bold uppercase text-white sm:text-base">
                  {name}
                </b>
              </div>
            </div>
